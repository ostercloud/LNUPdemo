...
Simple djanog app for display with the LNUP project
...
.. code-block:: bash
    ...
    heroku run python LNUPdemo/manage.py syncdb --noinput --settings=config.settings
    heroku run python LNUPdemo/manage.py migrate --settings=config.settings
    heroku run python LNUPdemo/manage.py collectstatic --settings=config.settings
